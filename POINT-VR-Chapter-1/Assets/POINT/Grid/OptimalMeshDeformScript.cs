...
public class OptimalMeshDeformScript : MonoBehaviour
{
    // <summary>
    // Optimized MeshDeformScipt for specific grid models.
    // Works on grid models that have not been touched in Blender and grid models that have been optimized for reduced number of verticies.
    // </summary>
