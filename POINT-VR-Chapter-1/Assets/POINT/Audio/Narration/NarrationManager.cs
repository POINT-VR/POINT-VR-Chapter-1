...
public class NarrationManager : MonoBehaviour
{
    ...
    {
        TextAsset txtAsset = Resources.Load<TextAsset>(audioName);
        LanguageCode(); // TODO: Append suffix to audio name; currently disabled for testing multiple languages in single file
        if (txtAsset == null)
        {
